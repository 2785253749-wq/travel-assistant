...
def test_itinerary_day_exposes_weather_status_directly():
    """Guards Task 5 consumers from needing an extra weather nesting level."""
    ...
    assert day.weather.status == "seasonal"
    assert day.weather.date == date(2026, 8, 12)
