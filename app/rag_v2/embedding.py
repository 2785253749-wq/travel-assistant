...
class JinaQueryProvider:
    """Thin Jina wire adapter for one query embedding request."""
...
class JinaQueryEmbedder:
    def __init__(self, *, provider: QueryEmbeddingProvider) -> None:
    ...
    def embed_query(self, query: str) -> tuple[float, ...]:
        try:
            ...
            return _validated_query_embedding(payload)
...
def _validated_query_embedding(payload: object) -> tuple[float, ...]:
