...
class SafeTravelAgent:
    ...
    def _hotel_nearby_result(
        self,
        message: str,
        *,
        extracted: HotelNearbyQueryExtraction | None = None,
    ) -> ChatResult:
        self._pending_hotel_nearby = None
        extracted = extracted or self._hotel_nearby_extractor.extract(message)
